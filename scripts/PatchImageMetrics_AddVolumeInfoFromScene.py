...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "scene_file", type=str, help="Path to the scene file used in generating images"
    )
...
def main():
    ...
    Or it might be incorrect/null. This scripts takes in a path to the root directory of where to search for json files and the path to the scene file used to generate the images
    """
