...
std::unique_ptr<star::StarPipeline> Volume::buildPipeline(star::core::devices::DeviceContext &device, vk::Extent2D swapChainExtent,
...
void Volume::prepRender(star::core::devices::DeviceContext &device, vk::Extent2D swapChainExtent, vk::PipelineLayout pipelineLayout,
...
void Volume::prepRender(star::core::devices::DeviceContext &device, int numSwapChainImages, star::StarPipeline &sharedPipeline,
                        star::StarShaderInfo::Builder fullEngineBuilder)
{
    RecordQueueFamilyInfo(device, this->computeQueueFamily, this->graphicsQueueFamily);
...
void Volume::RecordQueueFamilyInfo(star::core::devices::DeviceContext &device, uint32_t &computeQueueFamilyIndex,
