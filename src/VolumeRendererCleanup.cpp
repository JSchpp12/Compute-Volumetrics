...
{
	{
		...
		commandBuffer.pipelineBarrier(
			vk::PipelineStageFlagBits::eComputeShader,                        //which pipeline stages should occurr before barrier 
			vk::PipelineStageFlagBits::eFragmentShader,                   //pipeline stage in which operations will wait on the barrier 
			{},
			{},
			nullptr,
			barrier
