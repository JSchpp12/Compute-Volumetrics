...
class DescriptorBuilder
{
  public:
    ...
    DescriptorBuilder(const star::Handle *deviceID, renderer::volume::ContainerRenderResourceData data,
                      ...
                      vk::Pipeline *cachedDispatchCmdPipeline, star::core::device::StarDevice *device,
                      star::core::device::manager::GraphicsContainer *graphicsManagers,
                      star::ManagerRenderResource *resourceManager, star::common::EventBus *evtBus,
        ...
        : m_deviceID(deviceID), m_data(std::move(data)), m_staticShaderInfo(staticShaderInfo),
          ...
          m_cachedDispatchPipeline(cachedDispatchCmdPipeline), m_computePipelineLayout(computePipelineLayout),
          m_device(device), m_graphicsManagers(graphicsManagers), m_resourceManager(resourceManager), m_evtBus(evtBus),
  ...
  private:
    ...
    star::core::device::DeviceContext *m_ctx{nullptr};
    ...
    star::common::EventBus *m_evtBus{nullptr};
