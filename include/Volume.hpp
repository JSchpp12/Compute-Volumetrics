...
class Volume : public star::StarObject
{
  public:
    ...
    std::unique_ptr<star::StarPipeline> buildPipeline(star::core::devices::DeviceContext &device, vk::Extent2D swapChainExtent,
    ...
    virtual void prepRender(star::core::devices::DeviceContext& device, vk::Extent2D swapChainExtent, vk::PipelineLayout pipelineLayout,
                            star::RenderingTargetInfo renderingInfo, int numSwapChainImages,
                            star::StarShaderInfo::Builder fullEngineBuilder) override;

    virtual void prepRender(star::core::devices::DeviceContext& device, int numSwapChainImages, star::StarPipeline &sharedPipeline,
                            star::StarShaderInfo::Builder fullEngineBuilder) override;
  ...
  private:
    ...
    static void RecordQueueFamilyInfo(star::core::devices::DeviceContext &context, uint32_t &computeQueueFamilyIndex,
