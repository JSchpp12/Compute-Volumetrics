...
class Application : public star::StarApplication
{
  ...
  protected:
    std::shared_ptr<star::StarScene> createInitialScene(star::core::device::DeviceContext &device, const star::StarWindow &window,
                                                        const uint8_t &numFramesInFlight) override;

    virtual void startup(star::core::device::DeviceContext &device, const star::StarWindow &window,
                           const uint8_t &numFramesInFlight) override;
