...
class Application : public star::StarApplication
{
  ...
  protected:
    std::shared_ptr<star::StarScene> createInitialScene(star::core::devices::DeviceContext &device, const star::StarWindow &window,
                                                        const uint8_t &numFramesInFlight) override;

    virtual void startup(star::core::devices::DeviceContext &device, const star::StarWindow &window,
                           const uint8_t &numFramesInFlight) override;
