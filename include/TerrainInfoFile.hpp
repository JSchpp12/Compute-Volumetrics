...
public:
	struct TerrainInfo {
		...
		TerrainInfo(const glm::dvec2& cornerNE, const glm::dvec2& cornerSE, const glm::dvec2& cornerSW, const glm::dvec2& cornerNW, const glm::dvec2& center, const std::string& textureFile)
		: cornerNE(cornerNE), cornerSE(cornerSE), cornerSW(cornerSW), cornerNW(cornerNW), center(center), textureFile(textureFile) {}
	...
	const std::string getFullHeightFilePath() const {return this->fullHeightFilePath;}
