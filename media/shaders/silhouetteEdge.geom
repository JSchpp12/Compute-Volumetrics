...
void highlightEdge(const int vertf, const int verts){
    gl_Position = globalUbo.proj * gl_in[vertf].gl_Position;
    EmitVertex(); 
    gl_Position = globalUbo.proj * gl_in[verts].gl_Position; 
    EmitVertex(); 
    EndPrimitive(); 
}
